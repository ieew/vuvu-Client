...
###########################################################################
## Python code generated with wxFormBuilder (version 3.10.1-0-g8feb16b3)  # noqa
## http://www.wxformbuilder.org/  # noqa
##
## PLEASE DO *NOT* EDIT THIS FILE!  # noqa
###########################################################################
...
class window(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        成绩.Add(self.m_button历史, 0, wx.LEFT, 5)
        ...
        成绩.Add(self.m_button菜单, 0, wx.RIGHT, 5)
        ...
        self.文段 = wx.Button(self, wx.ID_ANY, u"无文段", wx.DefaultPosition, wx.Size(45, 20), wx.BORDER_NONE)
        self.文段.SetForegroundColour(wx.Colour(255, 255, 255))
        self.文段.SetBackgroundColour(wx.Colour(174, 86, 89))

        信息.Add(self.文段, 0, wx.LEFT, 5)
        ...
        self.标题 = wx.Button(self, wx.ID_ANY, u"无标题", wx.DefaultPosition, wx.Size(415, 20), wx.BORDER_NONE)
        ...
        self.m_gauge3 = wx.Gauge(self, wx.ID_ANY, 100, wx.DefaultPosition, wx.Size(630, 20), wx.GA_HORIZONTAL)
        ...
        进度.Add(self.m_gauge3, 0, wx.RIGHT | wx.LEFT, 5)

        状态栏.Add(进度, 1, 0, 5)

        fgSizer1.Add(状态栏, 1, wx.EXPAND, 5)

        self.m_textCtrl4 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.Point(-1, -1), wx.Size(630, 335), 0)
        self.m_textCtrl4.SetBackgroundColour(wx.Colour(228, 228, 228))

        fgSizer1.Add(self.m_textCtrl4, 0, wx.RIGHT | wx.LEFT, 5)

        bSizer4 = wx.BoxSizer(wx.HORIZONTAL)

        bSizer4.SetMinSize(wx.Size(-1, 15))
        ...
        bSizer4.Add(self.m_buttonS, 0, wx.LEFT, 5)
        ...
        bSizer4.Add(self.m_staticText跟打记录, 0, wx.RIGHT, 5)

        fgSizer1.Add(bSizer4, 1, wx.EXPAND, 5)

        self.m_textCtrl41 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(630, 110), wx.TE_MULTILINE)
        self.m_textCtrl41.SetBackgroundColour(wx.Colour(228, 228, 228))

        fgSizer1.Add(self.m_textCtrl41, 0, wx.BOTTOM | wx.RIGHT | wx.LEFT, 5)
